...
public class TpGr10 {
    public static void main (String[] args) {
        ...
        System.out.println (" Bienvenu(e) a notre programme de collecte de donnÃ©es statistiques ");
        System.out.println (" Le systÃ¨me collecte et calcule le statistique de tout les utilisatuers ");
        System.out.println();
        
        System.out.print ( " Vous dÃ©sirez entrer des informations aux fins de recherche et de statistique? (O,o,N,n): ");
        ...
        while (choix == 'O' || choix == 'o') {
            ...
            System.out.println (" 1 - 5 Ã  12 ans ");
            System.out.println (" 2 - 13 Ã  18 ans ");
            System.out.println (" 3 - 19 Ã  30 ans ");
            System.out.println (" 4 - 31 Ã  45 ans ");
            ...
            System.out.println (" Quel est votre saison prefÃ©ree? ");
            ...
            System.out.println (" Quel est votre couleur primaire prÃ©fÃ©rÃ©e? ");
            ...
            System.out.println (" Vous dÃ©sirez entrer des informations aux fins de recherche et de statistique? (O,o,N,n): ");
            choix = Clavier.lireCharLn();
            ...
            if (choix == 'N' || choix == 'n') {
                ...
                System.out.println( "Total rÃ©pondants : " + ( totalSexeMasc + totalSexeFem ));
                ...
                if (printempsFem == 0) {
                    ...
                    System.out.println( "Pourcentage femmes : " + ( printempsFem / ( printempsMasc + printempsFem )) * 100 + " %" );
                }
                System.out.println();
                ...
                if (automneMasc  == 0){ 
                    ...
                    System.out.println( "Pourcentage hommes : " + ( automneMasc / ( automneMasc + automneFem )) * 100 + " %" );
                }
                
                if (automneFem  == 0){ 
                    System.out.println( "Pourcentage femmes : 0% ");
                }else{
                    System.out.println( "Pourcentage femmes : " + ( automneFem / ( automneMasc + automneFem )) * 100 + " %" );
                }
                System.out.println();
                ...
                if (saisonGru1Pri  == 0){ 
                    ...
                    System.out.println("Printemps : " + ( saisonGru1Pri / ( saisonGru1Pri + saisonGru1Ete + saisonGru1Aut + saisonGru1Hiv )) * 100 + " %" );
                }
                
                if (saisonGru1Ete == 0){ 
                    System.out.println( "Pourcentage ete : 0% ");
                }else{
                    System.out.println("Ete : " + ( saisonGru1Ete / ( saisonGru1Pri + saisonGru1Ete + saisonGru1Aut + saisonGru1Hiv )) * 100 + " %" );
                }
                
                if (saisonGru1Aut == 0){ 
                    System.out.println( "Pourcentage automne : 0% ");
                }else{
                    System.out.println("Automne : " + ( saisonGru1Aut / ( saisonGru1Pri + saisonGru1Ete + saisonGru1Aut + saisonGru1Hiv )) * 100 + " %" );
                }
                
                if (saisonGru1Hiv == 0){ 
                    System.out.println( "Pourcentage hiver : 0% ");
                }else{
                    System.out.println("Hiver : "  + ( saisonGru1Hiv / ( saisonGru1Pri + saisonGru1Ete + saisonGru1Aut + saisonGru1Hiv )) * 100 + " %" );
                }
                System.out.println();
                ...
                if (saisonGru2Pri  == 0){ 
                    ...
                    System.out.println("Printemps : " + ( saisonGru2Pri / ( saisonGru2Pri + saisonGru2Ete + saisonGru2Aut + saisonGru2Hiv )) * 100 + " %" );
                }
                
                if (saisonGru2Ete == 0){ 
                    System.out.println( "Pourcentage ete : 0% ");
                }else{
                    System.out.println("Ete : " + ( saisonGru2Ete / ( saisonGru2Pri + saisonGru2Ete + saisonGru2Aut + saisonGru2Hiv )) * 100 + " %" );
                }
                
                if (saisonGru2Aut == 0){ 
                    System.out.println( "Pourcentage automne : 0% ");
                }else{
                    System.out.println("Automne : " + ( saisonGru2Aut / ( saisonGru2Pri + saisonGru2Ete + saisonGru2Aut + saisonGru2Hiv )) * 100 + " %" );
                }
                
                if (saisonGru2Hiv == 0){ 
                    System.out.println( "Pourcentage hiver : 0% ");
                }else{
                    System.out.println("Hiver : " + ( saisonGru2Hiv / ( saisonGru2Pri + saisonGru2Ete + saisonGru2Aut + saisonGru2Hiv )) * 100+ " %" );
                }
                System.out.println();
                ...
                if (saisonGru3Pri  == 0){ 
                    ...
                    System.out.println("Printemps :" + ( saisonGru3Pri / ( saisonGru3Pri + saisonGru3Ete + saisonGru3Aut + saisonGru3Hiv )) * 100 + " %" );
                }
                
                 if (saisonGru3Ete == 0){ 
                    System.out.println( "Pourcentage ete : 0% ");
                }else{
                    System.out.println("Ete : " + ( saisonGru3Ete / ( saisonGru3Pri + saisonGru3Ete + saisonGru3Aut + saisonGru3Hiv )) * 100 + " %" );
                }
                
                if (saisonGru3Aut == 0){ 
                    System.out.println( "Pourcentage automne : 0% ");
                }else{
                    System.out.println("Automne : " + ( saisonGru3Aut / ( saisonGru3Pri + saisonGru3Ete + saisonGru3Aut + saisonGru3Hiv )) * 100 + " %" );
                }
                
                if (saisonGru3Hiv == 0){ 
                    System.out.println( "Pourcentage hiver : 0% ");
                }else{
                    System.out.println("Hiver : " + ( saisonGru3Hiv / ( saisonGru3Pri + saisonGru3Ete + saisonGru3Aut + saisonGru3Hiv )) * 100 + " %" );
                }
                System.out.println();
                ...
                if (saisonGru4Pri  == 0){ 
                    ...
                    System.out.println("Printemps : " + ( saisonGru4Pri / ( saisonGru4Pri + saisonGru4Ete + saisonGru4Aut + saisonGru4Hiv )) * 100 + " %" );
                }
                
                 if (saisonGru4Ete == 0){ 
                    System.out.println( "Pourcentage ete : 0% ");
                }else{
                    System.out.println("Ete : " + ( saisonGru4Ete / ( saisonGru4Pri + saisonGru4Ete + saisonGru4Aut + saisonGru4Hiv )) * 100 + " %" );
                }
                
                if (saisonGru4Aut == 0){ 
                    System.out.println( "Pourcentage automne : 0% ");
                }else{
                    System.out.println("Automne: " + ( saisonGru4Aut / ( saisonGru4Pri + saisonGru4Ete + saisonGru4Aut + saisonGru4Hiv )) * 100 + " %" );
                }
                
                if (saisonGru4Hiv == 0){ 
                    System.out.println( "Pourcentage hiver : 0% ");
                }else{
                    System.out.println("Hiver : " + ( saisonGru4Hiv / ( saisonGru4Pri + saisonGru4Ete + saisonGru4Aut + saisonGru4Hiv )) * 100 + " %" );
                }
                System.out.println();
                ...
                if (saisonGru5Pri  == 0){ 
                    ...
                    System.out.println("Printemps : " + ( saisonGru5Pri / ( saisonGru5Pri + saisonGru5Ete + saisonGru5Aut + saisonGru5Hiv )) * 100 + " %" );
                }
                
                if (saisonGru5Ete == 0){ 
                    System.out.println( "Pourcentage ete : 0% ");
                }else{
                    System.out.println("Ete : " + ( saisonGru5Ete / ( saisonGru5Pri + saisonGru5Ete + saisonGru5Aut + saisonGru5Hiv )) * 100 + " %" );
                }
                
                 if (saisonGru5Aut == 0){ 
                    System.out.println( "Pourcentage automne : 0% ");
                }else{
                    System.out.println("Automne : " + ( saisonGru5Aut / ( saisonGru5Pri + saisonGru5Ete + saisonGru5Aut + saisonGru5Hiv )) * 100 + " %" );
                }
                
                if (saisonGru5Hiv == 0){ 
                    System.out.println( "Pourcentage hiver : 0% ");
                }else{
                    System.out.println("Hiver : " + ( saisonGru5Hiv / ( saisonGru5Pri + saisonGru5Ete + saisonGru5Aut + saisonGru5Hiv )) * 100 + " %" );
                }
            }
